...
# nohup bash ./sh_commands/sh_train_fcos_4gpu_01.sh >> ./log_0520_fcos_r50_caffe_fpn_gn-head_r1x_argoverse_640_chipr.log 2>&1 &
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash ./tools/dist_train.sh configs/fcos/fcos_r50_caffe_fpn_gn-head_r1x_argoverse_640_chipr.py 4

# nohup bash ./sh_commands/sh_train_fcos_4gpu_01.sh >> ./log_0520_fcos_r50_caffe_fpn_gn-head_r1x_argoverse_960_mix.log 2>&1 &
CUDA_VISIBLE_DEVICES=0,1,2,3 bash ./tools/dist_train.sh configs/fcos/fcos_r50_caffe_fpn_gn-head_r1x_argoverse_960_mix.py 4