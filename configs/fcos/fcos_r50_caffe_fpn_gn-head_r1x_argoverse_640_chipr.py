...
# optimizer
optimizer = dict(
    lr=0.01*24*4/(2*8), paramwise_cfg=dict(bias_lr_mult=2., bias_decay_mult=0.))
...
log_level = 'INFO'
load_from = 'work_dirs/fcos_r50_caffe_fpn_gn-head_r1x_argoverse_640_05191131/epoch_12.pth'
resume_from = None
workflow = [('train', 1)]
