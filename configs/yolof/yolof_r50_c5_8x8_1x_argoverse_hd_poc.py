# hc-y_modify1103:
# CUDA_VISIBLE_DEVICES=0,1,2,3 bash ./tools/dist_train.sh configs/yolof/yolof_r50_c5_8x8_1x_argoverse_hd_poc.py 4 
_base_ = [
...
# yapf:disable
log_config = dict(  # python3.9/site-packages/mmcv/runner/base_runner.py def register_logger_hooks();
    interval=50,
    hooks=[
        dict(type='TextLoggerHook'),
        # dict(type='TensorboardLoggerHook')  # python3.9/site-packages/mmcv/runner/hooks/logger/tensorboard.py class TensorboardLoggerHook()
    ])
# yapf:enable
