...
optimizer = dict(
    type='SGD',
    lr=0.01*4*2/(8*8),  # hc-y_modify0420:原始为lr=0.01 with num_GPU=8, samles_per_gpu=8;
    momentum=0.9,
    weight_decay=5e-4,
    nesterov=True,
...
max_epochs = 315
num_last_epochs = 15
resume_from = 'work_dirs/yolox_coco/yolox_l_8x8_300e_coco_20211126_140236-d3bd2b23.pth'
interval = 1
